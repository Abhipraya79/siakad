<aside class="fixed top-0 left-0 z-40 w-56 h-screen pt-14 transition-transform -translate-x-full border-r border-gray-200 md:translate-x-0 bg-[#14487a]">
    <div class="overflow-y-auto py-6 px-4 h-full">
        ...
        <ul class="space-y-3 text-sm">
            <li>
                <a href="{{ route('dosen.dashboard') }}" class="flex items-center p-2 text-white rounded-md hover:bg-yellow-500 hover:text-black transition">
            ...
            <li>
                <a href="{{ route('dosen.frs.index') }}" class="flex items-center p-2 text-white rounded-md hover:bg-yellow-500 hover:text-black transition">
                    <svg class="w-5 h-5 mr-3" fill="currentColor" viewBox="0 0 20 20">
            ...
            <li>
                <a href="{{ route('dosen.nilai.index') }}" class="flex items-center p-2 text-white rounded-md hover:bg-yellow-500 hover:text-black transition">
                    <svg class="w-5 h-5 mr-3" fill="currentColor" viewBox="0 0 20 20">
            ...
            <li>
                <a href="{{ route('dosen.jadwal.index') }}" class="flex items-center p-2 text-white rounded-md hover:bg-yellow-500 hover:text-black transition">
                    <svg class="w-5 h-5 mr-3" fill="currentColor" viewBox="0 0 20 20">
