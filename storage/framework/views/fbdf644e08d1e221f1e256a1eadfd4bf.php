...
<div class="max-w-lg w-full bg-white rounded-2xl shadow-xl overflow-hidden">
  <div class="p-6 text-center">
    ...
    <div class="space-y-4">
      <a href="<?php echo e(route('login.role',['role'=>'dosen'])); ?>"
      ...
      <a href="<?php echo e(route('login.role',['role'=>'mahasiswa'])); ?>"
...
<?php echo $__env->make('layouts.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\siakad\resources\views/welcome.blade.php ENDPATH**/ ?>